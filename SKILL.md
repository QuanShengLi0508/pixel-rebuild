...
8. Iterate in this order: geometry, missing objects/layering, flat colors, lines/markers, typography, antialiasing fringes.
9. Render twice from clean invocations and compare SHA-256 hashes. Confirm the script runs without the reference file.
